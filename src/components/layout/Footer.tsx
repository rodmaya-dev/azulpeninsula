      ...
      <div className="mx-auto grid max-w-container gap-10 px-6 py-14 md:grid-cols-[1.3fr_1fr_1fr_1fr]">
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2">
            {NAV_LINKS.map(({ href, labelKey }) => (
              <li key={href}>
                <Link href={href} className="text-sm text-text-mid hover:text-azul-mid">
                  {t(labelKey)}
                </Link>
              </li>
            ))}
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2 text-sm text-text-mid">
            <li>
              <a
                href={`https://wa.me/${siteConfig.telefonoWhatsApp}`}
                target="_blank"
            ...
            <li>
              <a href={`mailto:${siteConfig.email}`} className="hover:text-azul-mid">
                {siteConfig.email}
              </a>
            </li>
          </ul>
